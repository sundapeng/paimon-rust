...
//! Format Table partition path helpers shared by readers and SQL administration.
...
impl FormatTablePartitionPaths {
    ...
    pub fn name_prefix_pattern(&self, leading_values: &[String]) -> Option<String> {
...
pub(crate) fn format_partition_date(epoch_days: i32) -> Option<String> {
